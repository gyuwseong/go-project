...
const (
	...
	// CampaignServiceIssueCouponProcedure is the fully-qualified name of the CampaignService's
	// IssueCoupon RPC.
	CampaignServiceIssueCouponProcedure = "/campaign.v1.CampaignService/IssueCoupon"
)
...
func NewCampaignServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) CampaignServiceClient {
	...
	campaignServiceMethods := v1.File_coupon_v1_coupon_proto.Services().ByName("CampaignService").Methods()
	return &campaignServiceClient{
		...
		issueCoupon: connect.NewClient[v1.IssueCouponRequest, v1.IssueCouponResponse](
			httpClient,
			baseURL+CampaignServiceIssueCouponProcedure,
			connect.WithSchema(campaignServiceMethods.ByName("IssueCoupon")),
			connect.WithClientOptions(opts...),
		),
	}
}
...
// IssueCoupon calls campaign.v1.CampaignService.IssueCoupon.
func (c *campaignServiceClient) IssueCoupon(ctx context.Context, req *connect.Request[v1.IssueCouponRequest]) (*connect.Response[v1.IssueCouponResponse], error) {
...
func NewCampaignServiceHandler(svc CampaignServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	campaignServiceIssueCouponHandler := connect.NewUnaryHandler(
		CampaignServiceIssueCouponProcedure,
		svc.IssueCoupon,
		connect.WithSchema(campaignServiceMethods.ByName("IssueCoupon")),
		connect.WithHandlerOptions(opts...),
	)
	return "/campaign.v1.CampaignService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case CampaignServiceIssueCouponProcedure:
			campaignServiceIssueCouponHandler.ServeHTTP(w, r)
		default:
			http.NotFound(w, r)
		}
	})
...
func (UnimplementedCampaignServiceHandler) IssueCoupon(context.Context, *connect.Request[v1.IssueCouponRequest]) (*connect.Response[v1.IssueCouponResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("campaign.v1.CampaignService.IssueCoupon is not implemented"))
}
